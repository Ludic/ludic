...
export as namespace ludic
// app
export interface LudicAppConfig {
  el? : string | HTMLElement;
}
export interface UpdateFunction {
  (delta: number, ...rest: any[]): void
}
export class LudicApp {
  ...
  pause(): void;
  run(updateFunction?: UpdateFunction): void;
...
export class Asset {
  ...
  load(): void;
  onload(resolve: ()=>void, reject: ()=>void): ()=>void;
...
export class AssetManager {
  ...
  loadResource(name: string, url: string, type: string, options?: object, overwrite?: boolean): Promise<any>;
  getAsset(name: string): Asset;
  isLoading(): boolean;
  step(): void;
  setOnAssetsLoadedCallback(callback: (assetManager: AssetManager)=>void): void;
...
export class Canvas {
  el: HTMLElement;
  dimension: string;
  constructor(element: string | HTMLElement, dimension?: string);
...
export class ScreenManager {
  ...
  addScreen(screen: Screen, replace?: boolean): void
  popScreen(): Screen[];
...
export interface ScreenEventListener {
  onScreenFinished?(screen: Screen, manager: ScreenManager, data?: any): void;
  onScreenAdded?(screen: Screen, manager: ScreenManager, replaced: boolean): void;
  onScreensRemoved?(screen: Screen, manager: ScreenManager): void;
